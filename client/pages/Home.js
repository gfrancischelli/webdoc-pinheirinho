...
class Home extends React.Component {
  renderTimelineDescription() {
    return (
      <div>
        <p>
          A linha do tempo apresentada em
          {" "}
          <b>Pinheirinho, a luta continua</b>
          {" "}
          é uma plataforma construída especificamente para agregar o material documental de um dos maiores movimentos de ocupação urbana ocorridas no Estado de São Paulo desde a redemocratização brasileira. Através de uma plataforma interativa que permite a comunicação através de vários tipos de mídias (textos, vídeos, fotografias, documentos em PDF), é possível resgatar a história do movimento de maneira inédita.
        </p>
        <p>
        ...
        <p>
          Esperamos assim, contribuir para a documentação e memória das classes trabalhadoras, bem como servir de ferramenta para a organização das futuras lutas.
        </p>
      </div>
    );
  }
      ...
      <main id="main">
        ...
        <section className="o-band o-band">
          <div className="o-wrapper clearfix">
            <div className="o-wrapper__featured">
              <Link to="/timeline">
                <h3 className="c-heading c-heading--large@ds">
                  Linha do Tempo
                </h3>
              </Link>
            ...
            <Link to="/timeline" className="c-link u-float-right">
        ...
        <section className="o-band o-band--tint">
          <div className="o-wrapper clearfix">
            ...
            <h5>
              <Link to="/noticias" className="c-link u-float-right">
                mais notícias
              </Link>
            </h5>
          </div>
        ...
        <section className="o-band o-band--red">
          <div className="o-wrapper clearfix">
            ...
            <h5>
              <Link
                to="/noticias"
                className="c-link u-font-white u-float-right"
              >
                {" "}mais galerias
              </Link>
            </h5>
