	...
	(function (global, factory) {
	  ...
	  var IfExpr = {
	    ...
	    update: function update$1() {
	      ...
	      if (newValue) {
	        update$1$1.call(this.parentTag, this.expressions);
	      }
	    },
	...
	riot.tag2('contact-form', '<form ref="contactForm" onsubmit="{post}" class="c-form" method="post"> <div class="c-form__field"> <input ref="name" name="FullName" class="c-form__input" type="text" placeholder=" " required> <span class="fa fa-check-circle c-form__status-icon"></span> <label class="c-form__label" for="FullName">nome</label> </div> <div class="c-form__field"> <input ref="email" name="Email" class="c-form__input" placeholder=" " required type="email"> <span class="fa fa-check-circle c-form__status-icon"></span> <label class="c-form__label" for="Email">email</label> </div> <div class="c-form__field"> <input ref="subject" name="Subject" class="c-form__input" type="text" placeholder=" " required> <span class="fa fa-check-circle c-form__status-icon"></span> <label class="c-form__label" for="Subject">assunto</label> </div> <div class="c-form__field"> <textarea ref="content" name="Content" class="c-form__input" type="text" placeholder=" " required></textarea> <label class="c-form__label" for="Subject">mensagem</label> </div> <load-button message="{⁗Enviar⁗}" state="{status}"> <yield to="completed">Mensagem Enviada</yield> </load-button> </form>', '', '', function (opts) {
	    ...
	    this.post = function (e) {
	        ...
	        var body = JSON.stringify({
	            ...
	            address: _this.refs.email.value,
	            subject: _this.refs.subject.value,
